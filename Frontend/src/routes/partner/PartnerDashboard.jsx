      ...
      <div className="grid grid-cols-1 xs:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-6 sm:mb-8">
        {stats.map((stat, idx) => (
          ...
          >
            ...
            {/* Uncomment if you want to add view details link or leave this shi cause all the view detaild shld go to commin /partner/orders */}
            {/* <div className="flex items-center text-gray-600 mt-2 sm:mt-3">
