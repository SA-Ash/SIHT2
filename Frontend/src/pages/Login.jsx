  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (!isPartner && otpSent) {
        ...
        // Partner login - get partner data based on email
        const partnerEmail = partnerId; // Using partnerId as email for demo
        const partnerData = partnerDataService.getPartnerData(partnerEmail);
        ...
        // Store partner user data
        localStorage.setItem('accessToken', `mock_partner_token_${partnerData.id}`);
        localStorage.setItem('refreshToken', `mock_partner_refresh_token_${partnerData.id}`);
              ...
              {isPartner ? (
                <>
                  <li className="flex items-center">
                    <Check className="h-4 w-4 text-white mr-2" /> Manage student
                    print requests
                  </li>
                  <li className="flex items-center">
                ...
                <>
                  ...
                  <li className="flex items-center">
                    <Check className="h-4 w-4 text-white mr-2" /> Collect prints
                    hassle-free
                  </li>
                  <li className="flex items-center">
              ...
              <>
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    Demo emails: rishi.kumar199550@gmail.com, abcde@gmail.com, abcd@gmail.com
                  </p>
                </div>
