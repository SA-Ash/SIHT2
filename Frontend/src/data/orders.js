...
// <----------------------- This thing has many colors so gotta change ----------------------->
...
// <----------------------- This is most minimal cancels out paid , refunded , completed, Cancelled, Ready to be neutral gray color ----------------------->

// export const statusStyles = {
  //   Pending: "bg-amber-50 text-amber-700 border border-amber-200",
  //   Processing: "bg-blue-50 text-blue-700 border border-blue-200",
  //   Ready: "bg-gray-100 text-gray-700 border border-gray-300",
...
{/* <If Ashrith Reading this u Gay bro> */}